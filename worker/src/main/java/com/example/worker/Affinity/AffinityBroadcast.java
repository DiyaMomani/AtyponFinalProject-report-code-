...
public class AffinityBroadcast {
    @SneakyThrows
    public String buildDatabase(String dbName , String port){
    ...
    @SneakyThrows
    public String buildCollection(String dbName,String collectionName , String jsonObject , String port){
        String url = "http://"+port+":8080";
    ...
    @SneakyThrows
    public ApiResponse deleteDatabase(String dbName,String port){
        String url = "http://"+port+":8080";
        ...
        in.close();
        return new ApiResponse(response.toString(), conn.getResponseCode());
    }

    @SneakyThrows
    public String deleteCollection(String dbName,String collection , String port){
        String url = "http://"+port+":8080";
    ...
    @SneakyThrows
    public ApiResponse deleteWithId(String dbName,String collection ,String id, String port){
        String url = "http://"+port+":8080";
    ...
    @SneakyThrows
    public ApiResponse deleteAllOfValue(String dbName,String collection , String property,String value,String port){
        String url = "http://"+port+":8080";
